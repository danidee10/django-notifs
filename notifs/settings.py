"""
Django settings for django-notifs project.
...
SECRET_KEY = 'c+lvb#(*e84#c=fiwohxcg7(c$5d9ide1bw!7d4os4kzn)4c&c'
...
WSGI_APPLICATION = 'notifs.wsgi.application'
