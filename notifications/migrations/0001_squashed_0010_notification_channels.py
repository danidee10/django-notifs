...
class Migration(migrations.Migration):
    ...
    replaces = [('notifications', '0001_initial'), ('notifications', '0002_auto_20170718_1539'), ('notifications', '0003_auto_20170719_1137'), ('notifications', '0004_auto_20170719_1138'), ('notifications', '0005_auto_20170814_1118'), ('notifications', '0006_auto_20171005_0402'), ('notifications', '0007_auto_20171006_0126'), ('notifications', '0008_notification_extra_data'), ('notifications', '0009_auto_20180112_0915'), ('notifications', '0010_notification_channels')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channels', notifications.fields.ListField(default=('console',), max_length=200)),
            ],
            options={
                'ordering': ('-id',),
            },
